  ...
  await dbPool.query(
    `insert into policies (id, name, config_path)
     ...
     do update set
       name = excluded.name,
       config_path = excluded.config_path`,
    ["pilot-conservative", "Pilot Conservative Policy", "./policies/pilot-conservative.yaml"]
  );
  ...
  await dbPool.query(
    `insert into policies (id, name, config_path)
     ...
     do update set
       name = excluded.name,
       config_path = excluded.config_path`,
    ["pilot-stage5", "Pilot Stage 5 Policy", "./policies/pilot-stage5.yaml"]
  );
  ...
  await dbPool.query(
    `insert into policies (id, name, config_path)
     ...
     do update set
       name = excluded.name,
       config_path = excluded.config_path`,
    ["pilot-stage6", "Pilot Stage 6 Policy", "./policies/pilot-stage6.yaml"]
  );
  ...
  await dbPool.query(
    `insert into policies (id, name, config_path)
     ...
     do update set
       name = excluded.name,
       config_path = excluded.config_path`,
    ["pilot-stage8", "Pilot Stage 8 Policy", "./policies/pilot-stage8.yaml"]
  );
  ...
  await dbPool.query(
    `insert into policies (id, name, config_path)
     ...
     do update set
       name = excluded.name,
       config_path = excluded.config_path`,
    ["pilot-stage11", "Pilot Stage 11 Policy", "./policies/pilot-stage11.yaml"]
  );
